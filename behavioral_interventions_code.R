...
library(cowplot)
library(ggrepel) 
setwd("C:/Users/tarun/OneDrive - Hertie School/PhD/01 Household Interventions/Nature Upload/NE Submission3/Github uploads")
source("C:/Users/tarun/OneDrive - Hertie School/PhD/01 Household Interventions/Nature Upload/NE Submission3/Github uploads/functions_v1.R")

# SPECIFY INPUT FILE HERE

dfinc <- read_csv('included_studies_31032021.csv')
